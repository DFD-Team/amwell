...
export declare class TytoSetupWifi {
    handleNetworkDetails: EventEmitter;
    displayStep: EventEmitter;
    parentFunction: EventEmitter;
    messages: {
    ...
    wifiNetworkValue: string;
    wifiPasswordValue: string;
    onNextPress(e: Event): void;
    onPrevious(): void;
    handleHideShowPassword(): void;
    handleOnWifiNetworkInputBlur(value: any): void;
    handleOnWifiPasswordInputBlur(value: any): void;
    render(): any;
}
