...
export declare class TytoStepper {
    sdk: awsdk.AWSDK;
    ...
    currentStep: number;
    steps: number;
    tytoQRcodeComponents: HTMLTytoQrCodeElement;
    displayChangeNetwork: boolean;
    userNetworkDetails: any;
    showServicesUnavaiablePage: boolean;
    displayStepHandler(event: CustomEvent): void;
    devicePairedListener(): void;
    handleNetworkDetailsListener(event: CustomEvent): void;
    startNewQRCodeProcessListener(): void;
    showErrorPageListener(): void;
    render(): any;
}
