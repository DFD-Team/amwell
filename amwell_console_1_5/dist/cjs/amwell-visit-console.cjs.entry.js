...
const VisitConsole = class {
    ...
    async validateInitialize(sdk, options) {
        ...
        if (!match || compareVersions.compare(match[0], '3.2.0', '<')) {
            return Promise.reject('AWSDK must be at least version 3.2.0 or greater');
        }
        if (!options.visit) {
    ...
    setupOrientationHandler(initialOptions) {
        const hideHeaderInLandscape = (e) => {
            this.isHeaderDisabled = e.matches || initialOptions.disableHeader;
        };
        // we want to hide the header when we're in landscape mode without a lot of vertical height
        const mediaQuery = window.matchMedia("(max-height: 440px) and (orientation: landscape)");
    ...
    render() {
        ...
        return (index.h("div", { class: {
            ...
            index.h(DrawerButton, { name: this.messages.amwell_visit_console_drawer_tyto_button_text, className: 'tyto-button', selected: isTytoOpen, onClick: () => this.toggleDrawer('tyto') }, index.h(TytoIcon, null))), index.h("div", { class: "bottom-drawer" }, index.h("div", { class: "bottom-drawer-button", onClick: () => this.isBottomDrawerOpen = !this.isBottomDrawerOpen }), (this.showChatNotification || this.showNotesNotification) && index.h("div", { class: "notification-dot drawer-dot" }), index.h("div", { class: "bottom-drawer-content" }, index.h("div", { class: "bottom-drawer-buttons" }, showChat &&
