...
export class TytoPairingFailed {
    constructor() {
    ...
    render() {
        return (h("div", { class: "regenerate-qr-wrapper" },
            ...
            h("div", { class: "tyto-msg-wrapper" },
                h("div", { class: "tyto-message-details full_width" },
                    h("h1", null, this.messages.amwell_tyto_device_please_try_again),
                    h("p", null, this.messages.amwell_tyto_device_pairing_failure),
                    h("a", { href: "https://support.tytocare.com/", target: "_blank" }, this.messages.amwell_tyto_device_support_link))),
            h("div", { class: "buttons-container" },
                h("button", { type: "button", class: "blueBtn", onClick: () => this.onTryAgain() }, this.messages.amwell_tyto_device_try_again))));
    }
    static get is() { return "tyto-pairing-failed"; }
    static get originalStyleUrls() { return {
        "$": ["../tyto-pairing-fail/tyto-pairing-fail.css"]
    }; }
