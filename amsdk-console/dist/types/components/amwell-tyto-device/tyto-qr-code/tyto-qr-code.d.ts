...
export declare class TytoQRCode {
    displayStep: EventEmitter;
    startNewQRCodeProcess: EventEmitter;
    pairedDeviceSuccess: EventEmitter;
    showErrorPage: EventEmitter;
    messages: {
    ...
    private qrTimeToLiveTimeout;
    private pollingTimeoutId;
    private isPaired;
    readonly pairedDeviceTimeOut = 10000;
    readonly pollingInterval = 2000;
    readonly MINUTE: number;
    readonly qrTimeToLive: number;
    componentWillLoad(): void;
    handleCreateNewQRCode(ssid: string, ssidPwd: string): Promise<void>;
    beginPollingPairingStatus(): void;
    pollDevicePairingStatus(interval: any, timeout: any): Promise<unknown>;
    fetchQRCode(ssId: string, ssIdPwd: string): Promise<boolean>;
    clearTimeout(): void;
    displayErrorScreenBasedOnErrorCounter(): void;
    onBackBtnPress(): void;
    render(): any;
}
