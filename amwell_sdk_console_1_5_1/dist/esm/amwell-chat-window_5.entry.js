...
const ChatWindow = class {
    ...
    shouldEmitNewMessagesEvent(visit) {
        if (visit.chatReport && visit.chatReport.chatItems && visit.chatReport.chatItems.length) {
            const ordinalIsStale = visit.chatReport.lastOrdinal > this.lastOrdinal;
            const latestMessageIsProviderEntered = visit.chatReport.chatItems[visit.chatReport.chatItems.length - 1].messageType === 'ProviderEnter';
