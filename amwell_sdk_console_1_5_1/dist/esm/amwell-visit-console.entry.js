...
const VisitConsole = class {
    ...
    render() {
        ...
        return (h("div", { class: {
            ...
            h(DrawerButton, { name: this.messages.amwell_visit_console_drawer_tyto_button_text, className: 'tyto-button', selected: isTytoOpen, onClick: () => this.toggleDrawer('tyto') }, h(TytoIcon, null))), h("div", { class: "bottom-drawer" }, h("div", { class: "bottom-drawer-button", onClick: () => this.isBottomDrawerOpen = !this.isBottomDrawerOpen }), (this.showChatNotification || this.showNotesNotification) && h("div", { class: "notification-dot drawer-dot" }), h("div", { class: "bottom-drawer-content" }, h("div", { class: "bottom-drawer-buttons" }, showChat &&
