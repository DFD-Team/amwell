 ...
 * prior written authorization from American Well.
 */
var AdminMessage = function (_c) {
    var chatItem = _c.chatItem, i18messages = _c.i18messages;
    var title;
    var showBorder = true;
    ...
    return (h("div", { class: { 'chat-item': true, 'admin-message': true, 'admin-message-border': showBorder } }, title && h("h3", null, title), chatItem.message));
};
...
function parse(argument, dirtyOptions) {
    ...
    if (date) {
        ...
        if (dateStrings.timezone) {
            ...
            var offsetDiff = getTimezoneOffsetInMilliseconds(fullTimeDateNextDay) -
 ...
 * prior written authorization from American Well.
 */
var ChatMessage = function (_c) {
    var chatItem = _c.chatItem, showSubtitle = _c.showSubtitle;
    return (h("div", { class: { 'chat-item': true, 'self-message': chatItem.isSelf } }, h("div", { class: "chat-item-content" }, h("div", { class: "chat-item-bubble" }, h("div", { class: "chat-item-message" }, chatItem.message), h("div", { class: "chat-item-tail-outer" }, h("div", { class: "chat-item-tail-inner" }))), showSubtitle &&
        h("div", { class: "chat-item-subtitle" }, !chatItem.isSelf && h("span", null, chatItem.fullName), !chatItem.isSelf && h("span", null, "\u00A0-\u00A0"), h("span", null, dateFns_50(chatItem.date, 'h:mm A'))))));
};
var defaultMessages = {
...
var ChatWindow = /** @class */ (function () {
    ...
    class_2.prototype.initialize = function (sdk, options) {
    ...
    class_2.prototype.visitUpdated = function (newVisit) {
        if (!newVisit)
            return;
        var chatItems = (newVisit.chatReport && newVisit.chatReport.chatItems) || [];
        var newChatItemsExist = newVisit.chatReport && newVisit.chatReport.lastOrdinal > this.lastOrdinal;
        ...
        if (newChatItemsExist) {
            ...
            if (this.shouldEmitNewMessagesEvent(newVisit)) {
    ...
    class_2.prototype.shouldEmitNewMessagesEvent = function (visit) {
        if (visit.chatReport && visit.chatReport.chatItems && visit.chatReport.chatItems.length) {
            var ordinalIsStale = visit.chatReport.lastOrdinal > this.lastOrdinal;
            var latestMessageIsProviderEntered = visit.chatReport.chatItems[visit.chatReport.chatItems.length - 1].messageType === 'ProviderEnter';
            return ordinalIsStale && !latestMessageIsProviderEntered;
        }
        return false;
    };
    class_2.prototype.isTranscriptScrolledToBottom = function () {
    ...
    class_2.prototype.componentDidLoad = function () {
        ...
        if (document.head.attachShadow) {
            var simpleBar = new SimpleBar(this.transcript, { autoHide: false, direction: document.documentElement.dir });
    ...
    class_2.prototype.sendMessage = function (e) {
        var _this_1 = this;
        e.preventDefault();
        ...
        return this.sdk.visitService.addChatMessage(this.visit, this.input.value, this.lastOrdinal)
            ...
            _this_1.chatItems = __spreadArrays(_this_1.chatItems, report.chatItems);
            _this_1.input.value = '';
            _this_1.shouldScrollToBottom = true;
            _this_1.lastOrdinal = report.lastOrdinal;
        });
    };
    class_2.prototype.drawChatItems = function (chatItems) {
        var _this_1 = this;
        return chatItems.map(function (item, index) {
            // check if next message is from the same usertype as current message
            var wasSameSender = chatItems[index + 1] && item.userType === chatItems[index + 1].userType;
            // check if current message was sent within 1 minute of previous message
            var wasSentWithinAMinute = chatItems[index + 1] && item.date.getMinutes() === chatItems[index + 1].date.getMinutes();
            return _this_1.drawChatItem(item, !wasSameSender || !wasSentWithinAMinute);
        });
    };
    class_2.prototype.drawChatItem = function (chatItem, showSubtitle) {
    ...
    class_2.prototype.render = function () {
        var _this_1 = this;
        return (h("div", { class: "chat-window", dir: document.documentElement.dir }, h("div", { ref: function (el) { return _this_1.transcript = el; }, class: { 'transcript': true, 'hidden': this.chatItems.length === 0 }, "data-simplebar-direction": document.documentElement.dir }, h("div", null, h("div", { class: "chat-icon-bumper" }, h(LargeChatIcon, null)), this.drawChatItems(this.chatItems))), h("div", { class: { 'chat-placeholder': true, 'hidden': this.chatItems.length > 0 } }, h(LargeChatIcon, null), h("div", null, this.messages.amwell_chat_window_messages_placeholder)), h("div", { class: { 'new-message-toast-container': true, 'hidden': !this.showNewMessagesToast } }, h("div", { onClick: function () { return _this_1.scrollToBottom(); }, class: "new-message-toast" }, h("div", { class: "chevron down" }), h("div", null, this.messages.amwell_chat_window_new_messages_toast), h("div", { class: "chevron down" }))), h("form", null, h("input", { ref: function (el) { return _this_1.input = el; }, type: "text", placeholder: this.messages.amwell_chat_window_input_placeholder }), h("button", { type: "submit", onClick: function (e) { return _this_1.sendMessage(e); } }, h(SendIcon, null)))));
    };
...
var GuestInvite = /** @class */ (function () {
    ...
    class_3.prototype.initialize = function (sdk, options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_c) {
                this.sdk = sdk;
    ...
    class_3.prototype.destroy = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_c) {
                this.sdk = null;
                this.visit = null;
    ...
    class_3.prototype.visitUpdated = function (newVisit) {
        if (!newVisit)
            return;
        this.invitedGuests = newVisit.invitedGuestEmails || [];
    };
    class_3.prototype.removeInput = function (e, index) {
        e.preventDefault();
        this.emails.splice(index, 1);
        this.emails = __spreadArrays(this.emails);
    };
    class_3.prototype.addInput = function (e) {
        e.preventDefault();
        this.emails = __spreadArrays(this.emails, [{ value: '' }]);
        this.invitesSent = false;
    };
    class_3.prototype.checkEmailValidOrEmpty = function (emailString, allowEmpty) {
        var regex = /^[a-zA-Z0-9!#$%&amp;'*+\\/=?^_`{|}~-]+(?:\.[a-zA-Z0-9!#$%&amp;'*+\\/=?^_`{|}~-]+)*@(?:[a-zA-Z0-9](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?\.)+[a-zA-Z]{2,}$/;
    ...
    class_3.prototype.checkEmailExists = function (emailString) {
        var alreadyInvited = !!this.invitedGuests.find(function (guest) { return emailString.toUpperCase() == guest.toUpperCase(); });
        var alreadyEntered = (this.emails.filter(function (email) { return emailString.toUpperCase() == email.value.toUpperCase(); }).length > 1);
        return alreadyInvited || alreadyEntered;
    };
    class_3.prototype.validateEmail = function (email, allowEmpty) {
    ...
    class_3.prototype.handleOnEmailBlur = function (email, value) {
    ...
    class_3.prototype.shouldShowAddMoreButton = function () {
    ...
    class_3.prototype.shouldShowInviteSection = function () {
    ...
    class_3.prototype.shouldSendInvites = function () {
        var _this_1 = this;
        // validate all the emails
        this.emails.forEach(function (e) { return _this_1.validateEmail(e, false); });
        // check if we got any errors
        var emailsHaveNoErrors = this.emails.every(function (e) { return !e.error; });
    ...
    class_3.prototype.inviteGuests = function () {
        var _this_1 = this;
        ...
        // invite guest
        return this.sdk.visitService.inviteGuestsToVisit(this.visit, this.emails.map(function (e) { return e.value; }))
            .then(function (invites) {
            // clear out the inputs
            _this_1.emails = [];
            _this_1.invitesSent = true;
            // set invited guests to the list we get back, will be overwritten by what comes back on visit
            _this_1.invitedGuests = invites.filter(function (invite) { return invite.inviter === "CONSUMER"; }).map(function (invite) { return invite.email; });
        })
            .catch(function () {
            // make sure to revert this to false if we never actually sent the invites.
        })
            .finally(function () { return _this_1.pendingInvites = false; });
    };
    class_3.prototype.handleSendInvites = function (e) {
        return __awaiter(this, void 0, void 0, function () {
            var _a_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.inviteGuests()];
                    case 2:
                        _c.sent();
                        return [3 /*break*/, 4];
                    case 3:
    ...
    class_3.prototype.render = function () {
        var _this_1 = this;
        return (h("div", { class: "guest-invite", ref: function (el) { return _this_1.inviteScroll = el; }, dir: document.documentElement.dir, "data-simplebar-direction": document.documentElement.dir }, h("div", null, this.invitedGuests.length > 0 &&
            h("div", { class: "invited-guest-section" }, h("h3", null, this.messages.amwell_guest_invite_invited_guests_header), h("div", { class: "invited-guest-names" }, this.invitedGuests.sort(function (guest1, guest2) { return guest1.length - guest2.length; }).map(function (guest) { return [h("div", { title: guest, class: "invited-guest-name" }, guest), h("div", { class: "invited-guest-spacer" })]; })), h("div", { class: { "max-invited-message": true, "max-invited": !this.shouldShowInviteSection() } }, this.messages.amwell_guest_invite_invited_max)), this.shouldShowInviteSection() &&
            h("div", { class: "invite-guest-section" }, h("div", { class: "invite-guest-subtitle" }, this.messages.amwell_guest_invite_invite_guest_subtitle), h("div", { class: "invite-inputs" }, this.emails.map(function (email, index) { return h("div", { key: email.value + index, class: "input-group" }, h("floating-label-input", { error: email.error, label: _this_1.messages.amwell_guest_invite_input_label, value: email.value, hasFocus: _this_1.focusedIndex === index, handleOnFocus: function () { return _this_1.focusedIndex = index; }, handleOnBlur: function (e) { return _this_1.handleOnEmailBlur(email, e.target.value); } }), _this_1.emails.length > 1 &&
                h("button", { class: "link-like", onClick: function (e) { return _this_1.removeInput(e, index); } }, _this_1.messages.amwell_guest_invite_remove_text)); })), this.shouldShowAddMoreButton() &&
                h("button", { class: "add-another-button link-like", onClick: function (e) { return _this_1.addInput(e); } }, h("span", { class: "add-another-plus-sign" }, "\u271A"), h("span", { class: "add-another-text" }, this.messages.amwell_guest_invite_add_another_text)), h("button", { onClick: function (e) { return _this_1.handleSendInvites(e); }, class: { "send-invite-button": true,
            ...
            return __generator(this, function (_c) {
                ...
                this.sdk.deviceLiveStreamService
                    ...
                    if (response.devicePairingStatus.toString() === "PAIRED") {
                        _this_1.initializeStep = TytoWizardScreenType.DEVICE_PAIRED;
                        _this_1.isTytoDevicePaired = true;
                    }
                    else {
                        _this_1.initializeStep = TytoWizardScreenType.TYTO_DEVICE_INTAKE;
                    }
                })
                    .catch(function () {
                    _this_1.initializeStep = TytoWizardScreenType.TYTO_DEVICE_INTAKE;
...
var VideoConsole = /** @class */ (function () {
    ...
    class_5.prototype.initialize = function (sdk, options) {
        return __awaiter(this, void 0, void 0, function () {
            var filtered, contextElements, videoContext;
            var _this_1 = this;
            return __generator(this, function (_c) {
                this.sdk = sdk;
                this.visit = options.visit;
                this.messages = Object.assign({}, defaultMessages$2, options.messages);
                filtered = Object.keys(this.messages)
                    .filter(function (key) { return key.startsWith('amwell_video_console_'); })
                    .reduce(function (obj, key) {
                    obj[key.substring(21)] = _this_1.messages[key];
                    return obj;
                }, {});
                contextElements = {
                    // success is only called when visit ends, so pass back ended visit obj
                    successCallback: function (visit) {
                        _this_1.visit = null;
                        _this_1.visitEnd.emit({ visit: visit });
                    },
                    ...
                    errorCallback: function (visit, error) {
                        _this_1.visitError.emit({ visit: visit, error: error });
                    },
                    // just send back the most up to date visit
                    updatedCallback: function (visit) {
                        _this_1.visit = visit;
                        _this_1.visitUpdated.emit({ visit: visit });
                    },
                ...
                videoContext = this.sdk.visitService.createVideoContext(contextElements);
                return [2 /*return*/, this.sdk.visitService.startWebRTCVisit(this.visit, videoContext)
                        .then(function (videoConsole) {
                        _this_1.videoConsole = videoConsole;
                        return true;
                    })];
            });
        });
    };
    class_5.prototype.destroy = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_c) {
                this.sdk = null;
                this.visit = null;
    ...
    class_5.prototype.refresh = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_c) {
                if (this.videoConsole) {
 ...
 * prior written authorization from American Well.
 */
var NotesSection = function (props, children) { return (h("div", { ref: props.ref, class: props.class }, h("div", { class: "notes-section-header" }, props.title), children)); };
/*!
 * American Well Visit Console Widget
 *
 * Copyright © 2019 American Well.
 ...
 * prior written authorization from American Well.
 */
var NotesEntry = function (props) { return (h("div", { class: "notes-entry" }, props.title &&
    h("h3", null, props.title), props.description)); };
...
var VisitNotes = /** @class */ (function () {
    ...
    class_6.prototype.destroy = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_c) {
                this.sdk = null;
                this.visit = null;
    ...
    class_6.prototype.isNonEmpty = function (list) {
        return Array.isArray(list) && list.length > 0;
    };
    class_6.prototype.haveEntriesChanged = function (newEntries, oldEntries, comparisonKey) {
        var newEntriesExist = this.isNonEmpty(newEntries);
        var oldEntriesExist = this.isNonEmpty(oldEntries);
        // if old and new entries exist, check if they're different at all
        if (newEntriesExist && oldEntriesExist) {
            return !((newEntries.length === oldEntries.length) && newEntries.every(function (newEntry) { return oldEntries.find(function (oldEntry) { return newEntry[comparisonKey] === oldEntry[comparisonKey]; }); }));
        }
    ...
    class_6.prototype.visitUpdated = function (newVisit, oldVisit) {
        if (!newVisit)
            return;
        if (newVisit.providerEntries) {
            ...
            if (oldVisit && oldVisit.providerEntries) {
                var notesChanged = newVisit.providerEntries.notes !== oldVisit.providerEntries.notes;
                var prescriptionsChanged = this.haveEntriesChanged(newVisit.providerEntries.prescriptions, oldVisit.providerEntries.prescriptions, 'description');
                var diagnosesChanged = this.haveEntriesChanged(newVisit.providerEntries.diagnoses, oldVisit.providerEntries.diagnoses, 'displayName');
                var proceduresChanged = this.haveEntriesChanged(newVisit.providerEntries.procedures, oldVisit.providerEntries.procedures, 'displayName');
                var agendaItemsChanged = this.haveEntriesChanged(newVisit.providerEntries.agendaItemFollowUps, oldVisit.providerEntries.agendaItemFollowUps, 'description');
                var postVisitItemsChanged = this.haveEntriesChanged(newVisit.providerEntries.postVisitFollowUpItems, oldVisit.providerEntries.postVisitFollowUpItems, 'description');
    ...
    class_6.prototype.componentDidLoad = function () {
        // attach custom scrollbar to the transcript or fallback to default if no shadowDom support
        if (document.head.attachShadow) {
            var simpleBar = new SimpleBar(this.notesSection, { autoHide: false, direction: document.documentElement.dir });
    ...
    class_6.prototype.componentDidUpdate = function () {
        this.showAnchors = this.notesScroll && (this.notesScroll.scrollHeight > this.notesScroll.clientHeight);
    };
    class_6.prototype.scrollToNotesSection = function (e, anchor) {
        e.preventDefault();
    ...
    class_6.prototype.render = function () {
        ...
        return (h("div", { class: "visit-notes", dir: document.documentElement.dir }, h("div", { class: { "notes-anchors": true, "hidden": !this.showAnchors } }, this.notesExist &&
            h("button", { onClick: function (e) { return _this_1.scrollToNotesSection(e, _this_1.notesAnchor); } }, this.messages.amwell_visit_notes_notes_title), this.prescriptionsExist &&
            h("button", { onClick: function (e) { return _this_1.scrollToNotesSection(e, _this_1.prescriptionsAnchor); } }, this.messages.amwell_visit_notes_prescriptions_title), (this.diagnosesExist || this.proceduresExist) &&
            h("button", { onClick: function (e) { return _this_1.scrollToNotesSection(e, _this_1.diagnosesAndProceduresAnchor); } }, this.messages.amwell_visit_notes_diagnoses_and_procedures_title), (this.agendaItemsExist || this.postVisitItemsExist) &&
            h("button", { onClick: function (e) { return _this_1.scrollToNotesSection(e, _this_1.additionalItemsAnchor); } }, this.messages.amwell_visit_notes_additional_items_title)), h("div", { ref: function (el) { return _this_1.notesSection = el; }, class: "notes-sections", "data-simplebar-direction": document.documentElement.dir }, !this.notesExist
            ...
            h(NotesSection, { ref: function (el) { return _this_1.notesAnchor = el; }, class: "notes-section", title: this.messages.amwell_visit_notes_notes_title }, h("div", { innerHTML: this.visit.providerEntries.notes })), this.prescriptionsExist &&
            h(NotesSection, { ref: function (el) { return _this_1.prescriptionsAnchor = el; }, class: "notes-section", title: this.messages.amwell_visit_notes_prescriptions_title }, this.visit.providerEntries.prescriptions.map(function (prescription) { return h(NotesEntry, { title: prescription.description, description: prescription.rxInstructions }); })), (this.diagnosesExist || this.proceduresExist) &&
            h(NotesSection, { ref: function (el) { return _this_1.diagnosesAndProceduresAnchor = el; }, class: "notes-section", title: this.messages.amwell_visit_notes_diagnoses_and_procedures_title }, this.diagnosesExist && this.visit.providerEntries.diagnoses.map(function (diagnosis) { return h(NotesEntry, { title: diagnosis.displayName, description: diagnosis.description }); }), this.proceduresExist && this.visit.providerEntries.procedures.map(function (procedure) { return h(NotesEntry, { title: procedure.displayName, description: procedure.description }); })), (this.agendaItemsExist || this.postVisitItemsExist) &&
            h(NotesSection, { ref: function (el) { return _this_1.additionalItemsAnchor = el; }, class: "notes-section", title: this.messages.amwell_visit_notes_additional_items_title }, this.agendaItemsExist && this.visit.providerEntries.agendaItemFollowUps.map(function (item) { return h(NotesEntry, { description: item.description }); }), this.postVisitItemsExist && this.visit.providerEntries.postVisitFollowUpItems.map(function (item) { return h(NotesEntry, { description: item.description }); }))))));
    };
