...
var replace = unwrapExports(replace_1);
/*!
 ...
 * prior written authorization from American Well.
 */
var DrawerHeader = function (props) { return (h("div", { class: "visit-drawer-header" }, h("div", { class: "visit-drawer-title" }, props.name), h("div", { class: "visit-drawer-close-button", onClick: function (e) { return props.onCloseClicked(e); } }, h("svg", { width: "24", height: "24", viewBox: "0 0 24 24" }, h("path", { id: "a", d: "M10.943 12L4 5.057 5.057 4 12 10.943 18.943 4 20 5.057 13.057 12 20 18.943 18.943 20 12 13.057 5.057 20 4 18.943 10.943 12z" }))))); };
/*!
 * American Well Visit Console Widget
 *
 * Copyright © 2019 American Well.
 ...
 * prior written authorization from American Well.
 */
var DrawerButton = function (props, children) {
    var _a;
    return (h("div", { class: (_a = { 'drawer-button': true }, _a[props.className] = true, _a['selected'] = props.selected, _a), onClick: function (e) { return props.onClick(e); } }, h("div", { class: "drawer-icon" }, children), h("div", { class: "drawer-button-label" }, props.name), props.showNotificationDot && h("div", { class: "notification-dot" })));
};
/*!
 * American Well Visit Console Widget
 *
 ...
 * prior written authorization from American Well.
 */
var NotesIcon = function () { return (h("svg", { xmlns: "http://www.w3.org/2000/svg", width: "32", height: "32" }, h("g", { fill: "none", "fill-rule": "nonzero" }, h("g", { "stroke-width": "1.8", transform: "translate(6 1)" }, h("path", { d: "M16.486 1.74h3.066c.8 0 1.448.648 1.448 1.448v25.363c0 .8-.648 1.449-1.448 1.449H1.448C.648 30 0 29.351 0 28.55V3.189c0-.8.648-1.449 1.448-1.449h3.44" }), h("rect", { width: "10.248", height: "4.548", x: "5.376", y: ".9", rx: "1.449" })), h("rect", { width: "11", height: "2", x: "11", y: "12", rx: "1" }), h("rect", { width: "11", height: "2", x: "11", y: "17", rx: "1" }), h("rect", { width: "11", height: "2", x: "11", y: "22", rx: "1" })))); };
/*!
 * American Well Visit Console Widget
 *
 * Copyright © 2019 American Well.
 ...
 * prior written authorization from American Well.
 */
var InviteIcon = function () { return (h("svg", { xmlns: "http://www.w3.org/2000/svg", width: "32", height: "32" }, h("g", { fill: "none", "stroke-width": "2" }, h("path", { "stroke-linecap": "round", d: "M31 13h-7M27.5 9.5v7" }), h("path", { d: "M15.032 3c4.345 0 7.775 6.185 3.934 12.044-1.442 2.2-1.22 3.84 4.521 5.435 2.626.73 3.513 1.325 3.513 3.268V27a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1v-3.253c0-1.943.887-2.539 3.513-3.268 5.742-1.595 5.963-3.235 4.52-5.435C7.194 9.185 10.624 3 14.969 3h.064z" })))); };
/*!
 * American Well Visit Console Widget
 *
 * Copyright © 2019 American Well.
 ...
 * prior written authorization from American Well.
 */
var Modal = function (props) { return (h("div", { class: { "visit-console-modal-container": true, "hidden": !props.isOpen } }, h("div", { class: "visit-console-modal" }, h("div", { class: "visit-console-modal-header" }, props.title, props.closeOnClick &&
    h("button", { onClick: function (e) { return props.closeOnClick(e); } })), h("div", { class: "visit-console-modal-body" }, h("div", { class: "visit-console-modal-content", innerHTML: props.message }), h("div", { class: "visit-console-modal-buttons" }, props.button1Text && h("button", { onClick: function (e) { return props.button1OnClick && props.button1OnClick(e); } }, props.button1Text), props.button2Text && h("button", { onClick: function (e) { return props.button2OnClick && props.button2OnClick(e); } }, props.button2Text)))))); };
var defaultMessages = {
 ...
 * prior written authorization from American Well.
 */
var ReloadIcon = function () { return (h("svg", { width: "32", height: "32", viewBox: "0 0 32 32" }, h("g", { fill: "none", "fill-rule": "evenodd" }, h("g", { transform: "translate(3 3.518)" }, h("mask", null, h("path", { d: "M0 .865h25.385V26.25H0z" })), h("path", { d: "M24.2 10.953h-.028c-.668 0-1.157.598-1.066 1.259a9.677 9.677 0 0 1-.628 4.999c-1.527 3.804-5.045 6.585-9.137 6.832-6.754.408-12.254-5.605-10.964-12.501.786-4.212 4.193-7.57 8.41-8.32 2.848-.506 5.531.152 7.674 1.566h.77a.95.95 0 0 0 .95-.95V3.34A12.584 12.584 0 0 0 10.988.979C5.094 1.76.46 6.694.034 12.624c-.584 8.123 6.525 14.792 14.772 13.454 4.847-.786 8.854-4.43 10.132-9.172.464-1.723.548-3.403.34-4.991a1.093 1.093 0 0 0-1.079-.962", mask: "url(#b)" })), h("path", { d: "M23.663 10.229l-5.866.45a1.095 1.095 0 0 1-.168-2.182l4.94-.379-.38-4.941a1.094 1.094 0 0 1 2.183-.167l.45 5.865a1.26 1.26 0 0 1-1.16 1.354" })))); };
/*!
 * American Well Visit Console Widget
 *
 * Copyright © 2019 American Well.
 ...
 * prior written authorization from American Well.
 */
var TytoIcon = function () { return (h("svg", { xmlns: "http://www.w3.org/2000/svg", width: "32", height: "32" }, h("rect", { id: "backgroundrect", width: "100%", height: "100%", x: "0", y: "0", fill: "none", stroke: "none" }), h("path", { fill: "#ffffff", d: "M16.458 7.657c.785-1.598 2.371-2.692 4.2-2.692 2.61 0 4.725 2.223 4.725 4.966 0 2.742-2.115 4.965-4.725 4.965-1.829 0-3.415 1.076-4.2 2.649-.785-1.573-2.37-2.649-4.2-2.649-2.61 0-4.725-2.223-4.725-4.965 0-2.743 2.116-4.966 4.725-4.966 1.83 0 3.415 1.094 4.2 2.692M16.5 0C10.7 0 6 4.94 6 11.034v5.264C6 24.97 12.69 32 20.94 32h1.335c-1.913-1.51-3.15-3.913-3.15-6.62 0-4.571 3.526-8.276 7.875-8.276v-6.07C27 4.94 22.298 0 16.5 0M7.799 14.93c1.167 1.152 2.736 1.857 4.459 1.857 1.104 0 2.104.627 2.607 1.636l1.593 3.191 1.593-3.191c.504-1.01 1.503-1.636 2.607-1.636.493 0 .974-.058 1.436-.167-2.851 1.77-4.768 5.035-4.768 8.76 0 1.574.336 3.087.965 4.448C12.311 28.535 7.8 22.96 7.8 16.298V14.93m17.402-.083v.542c-.305.06-.605.136-.898.226.32-.228.62-.485.898-.768M16.5 1.89c1.555 0 3.017.431 4.282 1.186l-.124-.001c-1.57 0-3.046.584-4.2 1.607a6.313 6.313 0 0 0-4.2-1.607h-.039A8.322 8.322 0 0 1 16.5 1.89" }), h("path", { fill: "#ffffff", d: "M28 18a7 7 0 1 0 0 14V18zm-1.999 2.415v9.17A5.008 5.008 0 0 1 23 25 5.007 5.007 0 0 1 26 20.415zM20.5 9a1.5 1.5 0 1 0-.001 2.999A1.5 1.5 0 0 0 20.5 9M12.5 9a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3" }))); };
var VisitConsole = /** @class */ (function () {
    function class_1(hostRef) {
        registerInstance(this, hostRef);
        this.messages = defaultMessages;
    }
    class_1.prototype.onVisitEndListener = function () {
    ...
    class_1.prototype.onVisitUpdatedListener = function (event) {
     ...
     *
     */
    class_1.prototype.initialize = function (sdk, options) {
        return __awaiter(this, void 0, void 0, function () {
            var validationResult;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.validateInitialize(sdk, options)];
                    case 1:
                        ...
                        this.setupOrientationHandler(options);
                        return [2 /*return*/, this.videoConsole.initialize(this.sdk, options)
                                .then(function () { return _this.visitNotes.initialize(_this.sdk, options); })
                                .then(function () { return _this.chatWindow.initialize(_this.sdk, options); })
                                .then(function () { return _this.guestInvite.initialize(_this.sdk, options); })
                                .then(function () { return _this.tytoDevice.initialize(_this.sdk, options); })];
                }
            });
        });
    };
    class_1.prototype.validateInitialize = function (sdk, options) {
        return __awaiter(this, void 0, void 0, function () {
            var match;
            return __generator(this, function (_a) {
                if (!sdk) {
                    return [2 /*return*/, Promise.reject('AWSDK is null or undefined')];
                }
                match = sdk.version && sdk.version.match(/(\d\.\d\.\d)/);
                if (!match || compareVersions.compare(match[0], '3.6.0', '<')) {
                    return [2 /*return*/, Promise.reject('AWSDK must be at least version 3.6.0 or greater')];
                }
                if (!options.visit) {
                    return [2 /*return*/, Promise.reject('AWSDKVisit is null or undefined')];
                }
                if (!options.visit.disposition
                    ...
                    return [2 /*return*/, Promise.reject('AWSDKVisit must have disposition PreVisitScreening or InProgress')];
                }
                return [2 /*return*/];
            });
        });
    ...
    class_1.prototype.destroy = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.videoConsole.destroy()
                        .then(function () { return _this.visitNotes.destroy(); })
                        .then(function () { return _this.chatWindow.destroy(); })
                        .then(function () { return _this.guestInvite.destroy(); })];
            });
        });
    };
    class_1.prototype.msToTime = function (ms) {
        if (ms === void 0) { ms = 0; }
        var s = ms / 1000;
        var min = Math.floor(s / 60).toString().padStart(2, '0');
        var sec = Math.floor(s % 60).toString().padStart(2, '0');
        return min + ":" + sec;
    };
    class_1.prototype.toggleDrawer = function (drawerName) {
    ...
    class_1.prototype.acceptVisitExtension = function (accepted) {
        var _this = this;
        this.extensionOfferAcceptedOrRejected = true;
        this.sdk.visitService.acceptPaidVisitExtension(this.visit, accepted)
            .then(function () {
            _this.showVisitExtensionModal = false;
        })
            .catch(function () { });
    };
    class_1.prototype.setupOrientationHandler = function (initialOptions) {
        var _this = this;
        var hideHeaderInLandscape = function (e) {
            _this.isHeaderDisabled = e.matches || initialOptions.disableHeader;
        };
        // we want to hide the header when we're in landscape mode without a lot of vertical height
        var mediaQuery = window.matchMedia("(max-height: 440px) and (orientation: landscape)");
        // fire it once to set initial state based on orientation
        hideHeaderInLandscape(mediaQuery);
        // for backwards compat check the older signature first
        if (mediaQuery.addListener) {
            mediaQuery.addListener(hideHeaderInLandscape);
        }
        else {
            mediaQuery.addEventListener('change', hideHeaderInLandscape);
        }
    };
    class_1.prototype.render = function () {
        var _this = this;
        var showChat = !this.isSidebarDisabled && this.systemConfiguration && !this.systemConfiguration.alwaysHideChatTabEnabled;
        var showNotes = !this.isSidebarDisabled && this.systemConfiguration && !this.systemConfiguration.alwaysHideNotesTabEnabled;
        var showInvite = !this.isSidebarDisabled && this.systemConfiguration && this.systemConfiguration.multipleVideoParticipantsEnabled;
        var showTytoDrawer = !this.isSidebarDisabled && this.visit && this.visit.tytoLiveStreamingEnabled;
        var isChatOpen = showChat && this.isDrawerOpen && this.activeDrawerName === 'chat';
        var isNotesOpen = showNotes && this.isDrawerOpen && this.activeDrawerName === 'notes';
        var isInviteOpen = showInvite && this.isDrawerOpen && this.activeDrawerName === 'invite';
        var isTytoOpen = showTytoDrawer && this.isDrawerOpen && this.activeDrawerName === 'tyto';
        var hideSideBar = this.isSidebarDisabled || (!showChat && !showNotes && !showInvite && !showTytoDrawer);
        return (h("div", { class: {
            ...
            h(DrawerButton, { name: this.messages.amwell_visit_console_chat_button_text, className: 'chat-button', selected: isChatOpen, showNotificationDot: this.showChatNotification, onClick: function () { return _this.toggleDrawer('chat'); } }, h(ChatIcon, null)), showNotes &&
            h(DrawerButton, { name: this.messages.amwell_visit_console_notes_button_text, className: 'notes-button', selected: isNotesOpen, showNotificationDot: this.showNotesNotification, onClick: function () { return _this.toggleDrawer('notes'); } }, h(NotesIcon, null)), showInvite &&
            h(DrawerButton, { name: this.messages.amwell_visit_console_invite_button_text, className: 'invite-button', selected: isInviteOpen, onClick: function () { return _this.toggleDrawer('invite'); } }, h(InviteIcon, null)), showTytoDrawer &&
            h(DrawerButton, { name: this.messages.amwell_visit_console_drawer_tyto_button_text, className: 'tyto-button', selected: isTytoOpen, onClick: function () { return _this.toggleDrawer('tyto'); } }, h(TytoIcon, null))), h("div", { class: "bottom-drawer" }, h("div", { class: "bottom-drawer-button", onClick: function () { return _this.isBottomDrawerOpen = !_this.isBottomDrawerOpen; } }), (this.showChatNotification || this.showNotesNotification) && h("div", { class: "notification-dot drawer-dot" }), h("div", { class: "bottom-drawer-content" }, h("div", { class: "bottom-drawer-buttons" }, showChat &&
            h(DrawerButton, { name: this.messages.amwell_visit_console_chat_button_text, className: 'chat-button', showNotificationDot: this.showChatNotification, onClick: function () { return _this.toggleDrawer('chat'); } }, h(ChatIcon, null)), showNotes &&
            h(DrawerButton, { name: this.messages.amwell_visit_console_notes_button_text, className: 'notes-button', showNotificationDot: this.showNotesNotification, onClick: function () { return _this.toggleDrawer('notes'); } }, h(NotesIcon, null)), showInvite &&
            h(DrawerButton, { name: this.messages.amwell_visit_console_invite_button_text, className: 'invite-button', onClick: function () { return _this.toggleDrawer('invite'); } }, h(InviteIcon, null)), h(DrawerButton, { name: this.messages.amwell_visit_console_reload_button_text, className: 'reload-button', onClick: function () { return _this.videoConsole.refresh(); } }, h(ReloadIcon, null)), showTytoDrawer &&
            h(DrawerButton, { name: this.messages.amwell_visit_console_drawer_tyto_button_text, className: 'tyto-button', onClick: function () { return _this.toggleDrawer('tyto'); } }, h(TytoIcon, null))))), h("div", { class: { 'visit-drawer': true, 'side-shadow': true, 'hidden': !this.isDrawerOpen } }, h("div", { class: { 'drawer-content': true, 'chat-drawer': true, 'hidden': this.activeDrawerName !== 'chat' } }, h(DrawerHeader, { onCloseClicked: function () { return _this.isDrawerOpen = false; }, name: this.messages.amwell_visit_console_drawer_chat_title }), h("amwell-chat-window", { ref: function (el) { return _this.chatWindow = el; } })), h("div", { class: { 'drawer-content': true, 'notes-drawer': true, 'hidden': this.activeDrawerName !== 'notes' } }, h(DrawerHeader, { onCloseClicked: function () { return _this.isDrawerOpen = false; }, name: this.messages.amwell_visit_console_drawer_notes_title }), h("amwell-visit-notes", { ref: function (el) { return _this.visitNotes = el; } })), h("div", { class: { 'drawer-content': true, 'invite-drawer': true, 'hidden': this.activeDrawerName !== 'invite' } }, h(DrawerHeader, { onCloseClicked: function () { return _this.isDrawerOpen = false; }, name: this.messages.amwell_visit_console_drawer_invite_title }), h("amwell-guest-invite", { ref: function (el) { return _this.guestInvite = el; } })), h("div", { class: { 'drawer-content': true, 'tyto-device': true, 'hidden': this.activeDrawerName !== 'tyto' } }, h(DrawerHeader, { onCloseClicked: function () { return _this.isDrawerOpen = false; }, name: this.messages.amwell_visit_console_drawer_tyto_header_text }), h("amwell-tyto-device", { ref: function (el) { return _this.tytoDevice = el; } }))), h("amwell-video-console", { class: "video-console", ref: function (el) { return _this.videoConsole = el; } })), this.visit && this.visit.longExtensionEntity && this.systemConfiguration &&
